...
<head>
    ...
    <style>
        ...
        .modal-img-wrap img { transition: transform 0.5s cubic-bezier(0.25, 0.46, 0.45, 0.94); }
        ...
        #addrPrefillBanner {
            display: none;
            background: #f0faf4; border: 1.5px solid #a8e6c1;
            border-radius: 12px; padding: 10px 14px; margin-bottom: 16px;
            font-size: 13px; font-weight: 700; color: #0c7a3e;
            align-items: center; gap-8px;
        }
        #addrPrefillBanner.show { display: flex; }

        :root {
            --bg: #f3f4f6; --surface: #ffffff; --surface-2: #f9fafb;
            --border: #e5e7eb; --text-primary: #111827; --text-secondary: #6b7280;
            --text-muted: #9ca3af; --input-bg: #ffffff; --input-text: #374151;
        }
        [data-theme="dark"] {
            --bg: #1c2333; --surface: #263044; --surface-2: #202a3c;
            --border: #3a4a60; --text-primary: #f0f4ff; --text-secondary: #a0aec0;
            --text-muted: #6b7a99; --input-bg: #263044; --input-text: #e8edf8;
        }
        ...
        [data-theme="dark"] #addrPrefillBanner { background: rgba(12,122,62,0.15); border-color: #0c7a3e; }
    </style>
    <!-- in <head> -->
        ...
        <div class="checkout-box">
            ...
            <div id="checkStep1" class="px-8 py-6">
                ...
                <div class="grid grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <select name="city" id="addr_city" class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm font-semibold text-gray-700 outline-none focus:border-[#0c7a3e] font-[Nunito] bg-white">
            ...
            <div id="checkStep2" class="hidden px-8 py-6">
                ...
                <div class="flex gap-3">
                    <button onclick="goToStep(1, false)" class="flex-1 border border-gray-200 text-gray-500 rounded-2xl py-3.5 text-[14px] font-extrabold cursor-pointer font-[Nunito] bg-transparent transition-colors">← Back</button>
                    <button id="continueToReviewBtn" onclick="goToStep(3)" class="flex-[2] bg-[#0c7a3e] hover:bg-[#0a6633] text-white border-none rounded-2xl py-4 text-[15px] font-extrabold cursor-pointer font-[Nunito] transition-colors">Review Order →</button>
                </div>
            </div>
            ...
            <div id="checkStep3" class="hidden px-8 py-6">
                ...
                <div class="flex gap-3">
                    <button onclick="goToStep(2, false)" class="flex-1 border border-gray-200 text-gray-500 rounded-2xl py-3.5 text-[14px] font-extrabold cursor-pointer font-[Nunito] bg-transparent">← Back</button>
                    <button id="placeOrderBtn" onclick="placeOrder()" class="flex-[2] bg-[#0c7a3e] hover:bg-[#0a6633] text-white border-none rounded-2xl py-4 text-[15px] font-extrabold cursor-pointer font-[Nunito] transition-colors flex items-center justify-center gap-2">🎉 Place Order</button>
                </div>
            </div>
...
<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-6 h-6 opacity-35">
  ...
  <circle cx="34" cy="14" r="5" fill="#a5d6a7"/>
        ...
        function calcCartTotals() {
            ...
            return { totalItems, subtotal, total: subtotal }; // no tax
        }
